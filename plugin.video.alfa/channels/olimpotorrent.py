...
def is_detail_url(url):
    ...
    return '/pelicula/' in url.lower() or '/torrent/' in url.lower()

def is_listing_url(url):
    """Verificar si es URL de listado/categoría (a evitar)"""
    return any(s in url.lower() for s in ['/peliculas/', '/category/', '/categoria/', '/tag/', '/page/', '/year/', '/genero/', '/estrenos/', '/autor/'])
